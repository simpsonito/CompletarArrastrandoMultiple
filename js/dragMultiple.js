/**
 * Creado por Adib Abud el 8/10/14.
 */
var oDragTargets = [];
...
function HandleDragStop(){
    ...
    if (oDragTarget){
        //console.log("oDragTarget true: "+ oDragItem.getAttribute("data-tipo") + " - " + oDragTarget.getAttribute("data-destino"));
        if(oDragItem.getAttribute("data-tipo") == oDragTarget.getAttribute("data-destino")){
            ...
            oDragItem.intentos++;
            //console.log("intentos: "+oDragItem.intentos);
        ...
        //console.log("oDragTarget es falso, padre"+oDragItem.parentNode + " - original: " + oDragItem.padreOriginal);
        oDragItem.padreOriginal.appendChild(oDragItem);
        oDragItem.style.position="";
    }
...
function OnTargetOver(){
    oDragTarget.style.border = "1px solid red";
